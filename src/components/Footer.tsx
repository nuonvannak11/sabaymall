...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-6 px-2 sm:px-4 bg-gray-900 text-white dark:bg-gray-900 dark:text-white bg-gray-100 text-gray-800 transition-colors duration-300">
